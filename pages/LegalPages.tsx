      ...
      <div className="max-w-[800px] w-full prose dark:prose-invert">
        ...
        <div className="space-y-6 text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
          ...
          <section>
            ...
            <p>Kami menyediakan platform katalog online untuk produk UMKM. Dengan mengakses website ini, Anda dianggap telah memahami dan menyetujui syarat dan ketentuan yang berlaku.</p>
          </section>
